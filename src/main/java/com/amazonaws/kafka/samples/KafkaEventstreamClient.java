...
public class KafkaEventstreamClient {
    ...
    private void shutdown(List<RunProducer> executeTasks, ExecutorService executor, Producer<String, WorkspaceEvent> kafkaProducer) {
    ...
    private void runProducer() throws Exception {
        ...
        final Producer<String, WorkspaceEvent> kafkaProducer = new KafkaProducerFactory(propertiesFilePath, sslEnable, mTLSEnable, iamEnable, saslscramEnable, glueSchemaRegistry).createProducer();
    ...
    public static void main(String[] args) throws Exception {
        KafkaEventstreamClient client = new KafkaEventstreamClient();
